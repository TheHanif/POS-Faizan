...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2015 at 01:01 PM
...
CREATE TABLE IF NOT EXISTS `discount` (
  ...
  `min_purchase_qty` int(11) NOT NULL,
...
INSERT INTO `discount` (`id`, `product_id`, `discount_type`, `discount_amount`, `min_purchase_qty`, `type`, `status`, `datetime`) VALUES
(1, 2, 'flat', 10, 6, 'discount', 1, '2015-08-18 10:23:16'),
(2, 1, 'flat', 5, 6, 'discount', 1, '2015-08-18 10:40:22'),
(16, 3, '', 0, 10, 'offer', 0, '2015-08-19 06:44:07');
...
INSERT INTO `offers` (`id`, `promotion_id`, `product_id`, `product_quantity`, `status`, `datetime`) VALUES
(15, 16, 1, 1, 0, '2015-08-19 09:57:19'),
(16, 16, 2, 3, 0, '2015-08-19 09:57:19'),
(39, 16, 1, 2, 1, '2015-08-19 10:17:52'),
(40, 16, 2, 2, 1, '2015-08-19 10:17:52'),
(41, 16, 3, 2, 1, '2015-08-19 10:17:52');
...
(1, 'Pepsi Bottle 250ml', 2, '0', '0', '10', '123', '987654321', 'piece', 'ml', 24, 1, 2, '2015-08-12 05:00:29'),
...
(3, 1, 20, 39, 200, '987654321', 'bottle', 'ml', '2015-08-17 04:24:08');
