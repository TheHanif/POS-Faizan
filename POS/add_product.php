			...
			<div class="col-md-6">	
				<div class="form-group">
					...
					<div class="col-sm-8" style="margin-top:7px;">
						<?php if(isset($supplier_id)){ echo $suppliers_list->sup_name; 
						echo '<input type="hidden" name="p_supplier" value="'.$suppliers_list->sup_id.'"> '; }  ?>

						<?php 
						foreach($suppliers_list as $suplier){ ?>
							<?php (isset($ID))? $sup = $product_result->p_supplier : ''; if(isset($ID)){if($suplier->sup_id == $sup){echo $suplier->sup_name; 
